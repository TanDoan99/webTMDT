               ...
               <%--  <nav aria-label="Page navigation example">
                            ...
                            %>
                                ...
                                <%
    							 ...
    							 %>
                                            <li class="" ><a  href="<%=request.getContextPath()%>/index?page=<%=back%>">Previous</a></li>
                                <%
                                  }
                                %>
                                 	<%
                                        for(int i=1;i<=numberOfPages;i++){
                                    		if(currentPage==i){
                                 	 %>
                                            <li class="active" ><a  href="<%=request.getContextPath()%>/index?page=<%=i%>"><%=i %></a></li>
									<%
                                    		}else{
                                    %>
                                            <li class=" " ><a  href="<%=request.getContextPath()%>/index?page=<%=i%>"><%=i %></a></li>
									...
									%>		
                                            <li class="" ><a  href="<%=request.getContextPath()%>/index?page=<%=next%>">Next</a></li>
                                     <%
    										}
   									  %>
                                        </ul>
